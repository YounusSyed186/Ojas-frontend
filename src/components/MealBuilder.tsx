            ...
            <div className="relative">
              ...
              <div className="absolute -bottom-6 -left-6 glass rounded-3xl p-6 max-w-[260px] shadow-soft">
                ...
                <div className="grid grid-cols-3 gap-2 mt-4 pt-4 border-t border-foreground/10 text-center">
                  <div><div className="font-semibold text-sm">42g</div><div className="text-[10px] text-muted-foreground">Protein</div></div>
                  <div><div className="font-semibold text-sm">58g</div><div className="text-[10px] text-muted-foreground">Carbs</div></div>
                  <div><div className="font-semibold text-sm">22g</div><div className="text-[10px] text-muted-foreground">Fat</div></div>
                </div>
              </div>
